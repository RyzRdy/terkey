...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}Nazwa Salsabila'.center(53))
  ...
  def about(self):
    ...
    A program from {a}Nazwa Salsabila{c} for you.
    ...
    WhatsApp: {a}https://wa.me/12542123926
    Instagram: {a}https://instagram.com/nazwa.salsa_ig{b}
    And if you want to give me some money, you can visit
    {a}https://trakteer.id/nazwas{c}
    {a}https://saweria.co/nazwas{c}
    """
    )
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://wa.me/12542123926'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
